...
Original file is located at
    https://colab.research.google.com/drive/1d3VQzZgdqXcX8soYrUPCiwt7B78S2yje
"""
...
def eco_tips_generator(problem_keywords):
    prompt = f"Generate practical and actionable eco-friendly tips for sustainable living related to: {problem_keywords}. Provide specific solutions ans suggestions:"
...
with gr.Blocks() as app:
    gr.Markdown("# Eco Assistant & Policy Analzer")
